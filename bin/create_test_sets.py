...
from protnote.utils.configs import get_logger, load_config
...
if __name__ == "__main__":
    ...
    logger.info(
        "Updated Supervised Test Set. ProteInfer test seqs with new labels & new vocab...",
    )
    subprocess.run(
        [
            "python",
    ...
    logger.info(
        "Updated Supervised Test Set. ProteInfer test seqs with new labels & ProteInfer/old vocab...",
    )
    subprocess.run(
        [
            "python",
    ...
    logger.info(
        "GO Zero Shot 2024 Leaf Nodes. New seqs with new labels only leaf nodes & only added vocab terms",
    )
    subprocess.run(
        [
            "python",
    ...
    logger.info(
        "Updated Supervised Train Set. ProteInfer train seqs with all new & old labels.",
    )
    subprocess.run(
        [
            "python",
